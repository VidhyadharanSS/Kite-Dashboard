...
export function CreateResourceDialog({
    ...
    // Checks if the user's YAML still contains the mandatory security patterns defined in templates.ts
    const validateTemplateRules = (content: string, templateName: string): boolean => {
        const template = getTemplateByName(templateName)

        // If no template selected (scratch) or template has no specific rules, pass
                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        <span className="text-amber-600 font-medium text-xs">
                            Security Policy Enforced: Pod Security Contexts (User 1000, NonRoot) and Resource Quotas are mandatory.
                        </span>
                    </DialogDescription>
                </DialogHeader>
